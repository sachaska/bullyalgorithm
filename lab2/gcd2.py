...
class GroupCoordinatorDaemon(socketserver.BaseRequestHandler):
    """
    A Group Coordinator Daemon (GCD) which will respond with a list of potential group members to a text message BEGIN
    ...
    def handle_join(message):
        """
        Process this BEGIN message by adding new member into the group data structures.
