...
class GroupCoordinatorDaemon(socketserver.BaseRequestHandler):
    ...
    group members to a text message BEGIN with list of group members to contact.

    For Lab1, we just respond with a fixed list of a few members (one which
    should fail in order to test failure, too).
    """
